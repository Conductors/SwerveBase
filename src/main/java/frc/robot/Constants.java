...
public final class Constants {
    ...
    public static final double kFL_TurnEncoderOffset = 0.825;
    ...
    public static final double kFR_TurnEncoderOffset = 0.910;
    ...
    public static final double kBL_TurnEncoderOffset = 0.323;
    ...
    public static final double kBR_TurnEncoderOffset = 0.778;
